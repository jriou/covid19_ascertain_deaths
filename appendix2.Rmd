---
title: "All-cause mortality compared to expected mortality in Switzerland, February 2020 to January 2022"
...
t1a = summ_phase_base %>% 
  dplyr::transmute(phase=as.character(phase),
                   deaths,
                   expected_deaths=qsum(exp_deaths_med,exp_deaths_lob,exp_deaths_upb)) %>% 
  dplyr::bind_rows(
    summ_all_base %>% 
