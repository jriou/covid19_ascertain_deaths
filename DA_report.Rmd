...
Estimates of $\beta_1$ and $\beta_2$  across administrative regions show generally homogeneous results for the whole of Switzerland, bringing more weight to our results (online supplement **TO ADD**).
...
This is the first nationwide study in Switzerland that examines the interplay between laboratory confirmed deaths and excess deaths. 
Using a previously validated approach we estimated a relative excess mortality of 9.7%, with the excess being highest during the 3rd phase of the epidemic. 
We overall reported a close match between excess mortality and laboratory-confirmed COVID-19-related deaths. 
We employed a novel methodological approach, with different validation steps, and estimated almost 5,000 deaths directly attributable to COVID-19 without having positive test. 
The death ascertainment proportion was higher during the 3rd and 6th phase of the epidemic and in older populations. 
We also reported weak evidence that the COVID-19 pandemic had an indirect beneficial effect on all-cause mortality, particularly prominent in the younger age groups. 
...
Another mutli-country study  estimated 15,500 (95% uncertainty interval [UI]: 14,000 to 17,000) excess deaths in Switzerland in 2020 and 2021, which corresponds to 1.29 (95% UI: 1.16 to 1.42) times the number of laboratory-confirmed COVID-19 deaths [@wang2022estimating]. 
...
Another study in 5 European regions reported a relative excess mortality of 8\% in males and 9\% in females in Switzerland during the first year of the pandemic, but with larger uncertainty [@konstantinoudis2022regional].
However, the WHO estimates have been shown to be prone to bias [@noorden]. 
*The Economist* estimated 14,700 (95% UI: 14,400 to 15,400) excess deaths from January 2020 to June 2022 [@theeconomist]. 
In comparison with the previous studies, ours goes beyond estimating the excess mortality, and answers open questions about the direct and indirect effects of COVID-19 on mortality. 
In addition, out study is the unique as it models the population while propagating the estimated uncertainty, had the pandemic not occurred, as not accounting for population trends is expected to bias the number of deaths [@konstantinoudis2022regional]. 

## Interpretation

(AKIS: I am not familiar with this literature, I did a quick check and found the BMJ paper bellow in the url but the studies are not good and some of them not even studies. The BMJ paper reports also "Results from multiple European countries suggest at least 75% of COVID-19 deaths feature in official reports") but i couldnt find this information in the cited paper.)

We found that 62\% of the COVID-19 related deaths did not have a positive test. Previous reports of COVID-19 death ascertainment include 1/3 in Peru and South Africa, 10\% in India and 80\% in Brazil (AKIS: maybe cite this here: url{https://www.bmj.com/content/375/bmj.n2239}). 
Discrepancies with our study could be attributed to several factors, including the health-care system, testing capacity, but also differences in the methodology such as different study periods but also the statistical approach employed, as previous studies employ less rigorous methodological approaches to estimate death ascertainment.
We reported markedly lower ascertainment during periods of high epidemic activity, suggesting shortcomings concerning testing or reporting in overwhelmed healthcare institutions. 
...
Previous studies in multiple countries have reported or not mortality displacement (AKIS: maybe cite this here: url{https://www.bmj.com/content/373/bmj.n1137} and url{https://elifesciences.org/articles/69336}), but none has attempted to quantify it. 
We found that in Switzerland, a country characterized by high socio-economic development and a strong healthcare system, the COVID-19 pandemic had an indirect beneficial effect on all-cause mortality.
...
Of note, the deficit of deaths not directly related to COVID-19 was mostly evident in the younger age groups, and not in populations over 70 years old where mortality displacement is to be expected.
This deficit could be an attribute to the indirect effect of the pandemic, including NPIs and its consequences such as reductions in mobility and traffic, social contacts and activities, or air pollution levels [@saladie2020covid][@chen2020air].
...
The fact that it mostly occurred in age groups 40 to 69 favors explanations relating to reductions in mobility, traffic and outdoor activities, as opposed to a reduced circulation of other pathogens such as influenza, which would have led to mortality deficits in the older populations.
Our study does not provide evidence of any harmful effects due to the pandemic, such as delays or avoidance of medical care [@riera2021delays][@czeisler2020delay], increases in substance use and suicidal ideation [@zaami2020new][@czeisler2021mental] or increases in interpersonal violence [@mazza2020danger]. 
...
(AKIS: The following paragraph is not really my strong point in research but I tried to write smth wrt public health policies. Feel free to modify/delete as you feel is suitable.)

We observed biases in surveillance that have caused a great underestimation of deaths, particularly in older populations. 
This suggests engagement and efforts to improve the coverage and capacity of existing testing regimes in places with older populations for instance in retirement and nursing homes. 
Efforts in educating about the importance of accurate report of COVID-19 deaths should be taken through seminars/webminars and xx.
We particularly highlight the importance of communicating the observed under-report of COVID-19 death toll, suggesting establishing robust safeguards to avoid distortion of official statistics for political motives, including vaccination of the population which currently the uptake in Switzerland is low (AKIS: Is this the case still?) (cite: url{https://www.bmj.com/content/375/bmj.n2239}).
Policies to boost vaccination in the older populations including education towards vaccination and better accessibility are required to mitigate the total pandemic death toll.
The observed weak evidence of a harvesting effect in the younger population is conditional on the NPIs and by no means suggests that younger populations are immune to COVID-19.
