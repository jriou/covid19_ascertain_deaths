...
Figure 1 illustrates the % change in relative mortality had the pandemic not occurred in Switzerland during 2020-2021. We observe that during the 2 pandemic years there was overall increase in the relative excess mortality of 3.09% (95% CrI: -4.30, 11.2), with phase 3 (covering the period between 28 September 2020 and 15 February 2021) being the period with the highest relative excess mortality (24.4, 95% CrI: 14.7, 35.5), panel A in Figure 1. We found evidence of a harvesting effect during phase 4 (covering the period between 15 February 2021 and 21 June 2021) of the pandemic with the relative excess mortality being -11.7 (95% CrI: -20.0, -2.47), with the relative excess mortality being also negative with weaker evidence during phase 2 and 5. The age groups affected most by the pandemic were the ones over 70, whereas the cantons affected the most during these 2 years were Glarus and Jura, panel A in Figure 1. During the first phase of the pandemic the areas hit the most were the ones near the borders with France and Italy (cantons of Ticino, Geneva and Vaud), whereas during the third phase of the pandemic in Switzerland, the effect of the pandemic on all cause mortality was homogeneous across the country, reflecting that the virus was no longer exogenous as it was during phase 1 [@konstantinoudis2022regional].  
