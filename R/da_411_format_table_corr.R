...
da_411_format_table_corr <- function(summaries,betas,indirect) {
  ...
  tab = summaries %>% 
    dplyr::transmute(laboratory=formatC(labo_deaths, format="f", big.mark=",", digits=0),
                  ...
                  corr_exp_deaths=qsumx(corr_exp_deaths_med,corr_exp_deaths_lob,corr_exp_deaths_upb),
                  corr_exp_deaths=qsumx(corr_exp_deaths_med,corr_exp_deaths_lob,corr_exp_deaths_upb),
                  corr_excess=qsumx(corr_excess_med,corr_excess_lob,corr_excess_upb)) %>% 
