...
if(overdispersion == TRUE){
  clusterExport(cl, c("dat_fin", "mod", "Tot", "params", "ran.sam.it", "select.rate.param"))
}else{
...
saveRDS(result, file = paste0("savepoint/SamplesBMAtrun_", by, "_", nam, cor.nam, ov, rateparam))
