...
nointeractions <- readRDS(file.path(controls$savepoint,"popcv_nointeractions"))
nointeractionsov <- readRDS(file.path(controls$savepoint,"popcv_nointeractionsov"))
interactionsov <- readRDS(file.path(controls$savepoint,"popcv_interactionsov"))
randomslope <- readRDS(file.path(controls$savepoint,"popcv_randomslope"))
randomslopeov <- readRDS(file.path(controls$savepoint,"popcv_randomslopeov"))
randomslopeintov <- readRDS(file.path(controls$savepoint,"popcv_randomslopeintov"))
...
nointeractions <- readRDS(file.path(controls$savepoint,"popcv3y_nointeractions"))
nointeractionsov <- readRDS(file.path(controls$savepoint,"popcv3y_nointeractionsov"))
interactionsov <- readRDS(file.path(controls$savepoint,"popcv3y_interactionsov"))
randomslope <- readRDS(file.path(controls$savepoint,"popcv3y_randomslope"))
randomslopeov <- readRDS(file.path(controls$savepoint,"popcv3y_randomslopeov"))
randomslopeintov <- readRDS(file.path(controls$savepoint,"popcv3y_randomslopeintov"))
...
data.frame(MSE = c(res_checks_noint$MSE, 
...
ggplot() + geom_boxplot(data = res_MSE, aes(x = type, y = MSE), outlier.size = 1.2) + 
  theme_bw() + scale_fill_viridis_d() + ylab("RMSE")
res_MSE %>% group_by(type) %>% summarize(med = mean(MSE))  %>% summarize(med = sqrt(med))
