...
##
## Check one overdispersed, as for the previous combination of the samples I have excluded the u-s
...
##
## and compare
sapply(store.list, function(X)X$cov.prob)
sapply(store.list2, function(X)X$cov.prob)

sapply(store.list, function(X)X$cor)^2
sapply(store.list2, function(X)X$cor)^2
